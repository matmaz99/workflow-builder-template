 ...
 *
 * Additionally generates codegen templates from step files that export
 * a stepHandler function, enabling unified step code between app and exports.
 *
 * Run this script:
...
function processNode(
  ...
  // Check for exported stepHandler function
